        ...
        <div className="row mb-5">
            ...
            <div className="col-6 d-none d-lg-block">
                <div className="btn-group border p-1 rounded" role="group" aria-label="Basic radio toggle button group">
                    ...
                    <label className="btn btn-outline-primary" for="btnradio1">Today</label>
                    <input type="radio" className="btn-check" name="btnradio" id="btnradio2" autocomplete="off" />
                    <label className="btn " for="btnradio2">Last 7 Days</label>

                    <input type="radio" className="btn-check" name="btnradio" id="btnradio3" autocomplete="off" />
                    <label className="btn " for="btnradio3">Last 30 Days</label> */}
                </div>
            </div>
            ...
            <div className="col-12 mt-5  d-none d-lg-block p-4 mb-5">
                <div className="row px-5">
                    {topCollections && topCollections?.map((items, key) => (
                        <div key={key} className="col-lg-6 col-md-6 px-3">
